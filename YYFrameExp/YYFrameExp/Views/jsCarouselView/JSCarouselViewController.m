...
@interface JSCarouselViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSLog(@"你选择了第%d个选项卡", indexPath.row + 1);
