...
@interface PullDownMenuView ()<UITableViewDataSource,UITableViewDelegate>
{
...
-(void)show
{
    ...
    [_backButton setFrame:[UIScreen mainScreen].bounds];
    [_backButton addTarget:self action:@selector(dismiss) forControlEvents:UIControlEventTouchUpInside];
    _backButton.backgroundColor = [UIColor clearColor];
    [_backButton addSubview:self];
    
    //此view加在window上
    UIWindow *mainWindow =[UIApplication sharedApplication].keyWindow;
    [mainWindow addSubview:_backButton];
    
    
    //展示时的动画
    CGPoint arrowPoint = [self convertPoint:self.showPoint fromView:_backButton];
