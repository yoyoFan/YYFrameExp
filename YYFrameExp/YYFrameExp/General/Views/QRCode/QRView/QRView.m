...
- (void)addScreenFillRect:(CGContextRef)ctx rect:(CGRect)rect {
    ...
    CGContextSetRGBFillColor(ctx, 40 / 255.0,40 / 255.0,40 / 255.0,0.5);//(ctx, 40 / 255.0,40 / 255.0,40 / 255.0,0.5)
...
- (void)addCornerLineWithContext:(CGContextRef)ctx rect:(CGRect)rect{
    ...
    CGContextSetRGBStrokeColor(ctx, 228 /255.0, 74/255.0, 74/255.0, 1);//绿色//(ctx, 83 /255.0, 239/255.0, 111/255.0, 1);
    //左上角
